    ...
    while {j0k3r5_stats} do
	{
		...
		hintSilent parseText format 
			[
				...
				<img size='6' image='%10'/>
				<br/>
				<t size='1'		font='Bitstream'align='center'>Absence.com.ua</t><br/>
				<t size='1'		font='Bitstream'align='center'>TS3: 176.36.87.109</t>
				<br/>
				<br/>
				...
				_headShots,													//6
				(dayz_Survived),											//7
				(358-(round(serverTime/60))),								//8 change the 180 to suit your server mins for restarts
				_pic,														//9
				_logo,														//10
				_textCity,													//11
