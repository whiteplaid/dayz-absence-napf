...
private ["_backpack","_started","_canceltrade","_finished","_animState","_isMedic","_isOk",
		"_goStart","_tPassed","_sTime","_display","_tradeCancel","_pStartPos","_sMagCounts",
...
if (count(_preTestCargoCounts select 0) == 0) exitWith { tfv_IS_TRADING = false; systemChat format [tfv_NO_BP_MAGAZINES,typeOf _backpack]; PVDZE_Server_Simulation = [_backpack, true]; publicVariableServer "PVDZE_Server_Simulation";};
